# tool-business-mail-block Constitution

この文書は、tool-business-mail-block の開発組織における最上位 contract です。
...
tool-business-mail-block の開発組織の目的は current procedure への服従ではありません。
...
This repository owns the Business Mail Block source embedded into my-web-2025. Host and shared UI repositories remain separate authorities.
